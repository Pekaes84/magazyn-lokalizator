...
export function InventoryRow({
  ...
  return <div className="border border-border rounded-lg overflow-hidden bg-card transition-all hover:shadow-md">
      ...
      {isExpanded && <div className="border-t border-border bg-muted/30 p-4 animate-slide-up">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center pt-2">
                  ...
                  {isLoadingDetails ? <div className="flex items-center gap-2 text-muted-foreground">
                      <Loader2 className="w-4 h-4 animate-spin" />
                      <span className="text-sm">Sprawdzanie...</span>
                    </div> : getAvailabilityBadge() || <Badge variant="outline">Brak danych</Badge>}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="aspect-square max-w-[200px] rounded-lg border border-border overflow-hidden bg-muted">
                {isLoadingDetails ? <div className="w-full h-full flex items-center justify-center">
                    <Loader2 className="w-8 h-8 animate-spin text-muted-foreground" />
                  </div> : productDetails?.imageUrl ? <img src={productDetails.imageUrl} alt={item.Nazwa || item.Symbol} className="w-full h-full object-contain" onError={e => {
