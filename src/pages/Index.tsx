  ...
  return <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Results */}
          <InventoryList items={items} isLoading={isLoading} searchTerm={searchTerm} isAdmin={true} onEdit={handleEdit} onDelete={handleDelete} />
        </div>
      </main>
      ...
      {/* Dialogs */}
      <InventoryFormDialog open={showFormDialog} onOpenChange={open => {
      setShowFormDialog(open);
      if (!open) setEditingItem(null);
    }} item={editingItem} onSave={handleSave} isLoading={createMutation.isPending || updateMutation.isPending} />

      <DeleteConfirmDialog open={showDeleteDialog} onOpenChange={open => {
      setShowDeleteDialog(open);
      if (!open) setDeletingItem(null);
    }} item={deletingItem} onConfirm={handleConfirmDelete} />
    </div>;
};
